...
export const drawInstructions = (context, canvas, instructionPng) => {
  context.drawImage(
    instructionPng,
    ((65/1440) * canvas.width),
    ((235/810) * canvas.height),
    ((200/1440) * canvas.width),
    ((300/810) * canvas.height)
  );
}
