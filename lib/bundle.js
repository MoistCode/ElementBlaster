...
function drawControlsBorder(context) {
  ...
  context.moveTo(109, 435);
  context.lineTo(109, 465);
  context.stroke();
  context.closePath();

  context.beginPath();
  context.rect(194, 450, 50, 25);
  context.stroke();
  context.closePath();
  ...
  context.font = '15px Verdana';
  context.fillText('Shoot', 92, 515);
  context.font = '15px Verdana';
  context.fillText('Switch Elements', 168, 515);
}
...
function drawElements(context, element) {
  switch (element) {
    case 'Fire':
