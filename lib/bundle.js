...
var HumanPlayer = function (_Player) {
  ...
  function HumanPlayer(x, y, color, canvas, context) {
    _classCallCheck(this, HumanPlayer);

    return _possibleConstructorReturn(this, (HumanPlayer.__proto__ || Object.getPrototypeOf(HumanPlayer)).call(this, x, y, color, canvas, context));
  }
...
var _humanplayer = __webpack_require__(1);
...
var _generateHumanPlayer = function _generateHumanPlayer(context, canvas) {
  var humanPlayer = new _humanplayer2.default(Math.random() * canvas.width, Math.random() * canvas.height, 'blue', canvas, context);
};

var _generateComputerPlayers = function _generateComputerPlayers() {};
...
var Player = function () {
  function Player(coordX, coordY, color, canvas, context) {
...
var ComputerPlayer = function (_Player) {
  ...
  function ComputerPlayer() {
    ...
    return _possibleConstructorReturn(this, (ComputerPlayer.__proto__ || Object.getPrototypeOf(ComputerPlayer)).call(this));
  }
