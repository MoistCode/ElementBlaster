...
document.addEventListener("DOMContentLoaded", function () {
  ...
  gameoverPng.src = '../assets/images/gameover.png';
  ...
  restartButton.addEventListener('click', function () {
    if (!humanPlayer.alive || Object.values((0, _player.getAllPlayers)()).length == 1) {
      clearInterval(endlessInterval);
...
var generateGameover = function generateGameover(context, canvas, gameoverPng) {
  context.drawImage(gameoverPng, 330 / 1440 * canvas.width, 0 / 810 * canvas.height, 1110 / 1440 * canvas.width, 808 / 810 * canvas.height);
};
