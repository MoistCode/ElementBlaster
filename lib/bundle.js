...
var _generateHumanPlayer = function _generateHumanPlayer(context, canvas) {
  var humanPlayer = new _humanplayer2.default(context, canvas);
};

var _generateComputerPlayers = function _generateComputerPlayers(context, canvas) {
  var computer = new _computerplayer2.default(context, canvas);
};
...
var Player = function () {
  function Player(context, canvas) {
    ...
    this.coordX = Math.random() * (1070 / 1440 * canvas.width) + 340 / 1440 * canvas.width;
    this.coordY = Math.random() * (715 / 810 * canvas.height) + 40 / 810 * canvas.height;
