    ...
    var _loop2 = function _loop2(j) {
      setTimeout(function () {
        if (i == 5 && j >= 4) {
          ...
          context.drawImage(explosionPng, 50, 50, 200 / 11, 200 / 11, 1 / j * (200 / 11), 0, 200 / 11, 200 / 11);
        } else if (j == 0) {
          context.drawImage(explosionPng, 50, 50, 200 / 11, 200 / 11, 0, 1 / i * (200 / 11), 200 / 11, 200 / 11);
        } else {
          context.drawImage(explosionPng, 50, 50, 200 / 11, 200 / 11, 1 / j * (200 / 11), 1 / i * (200 / 11), 200 / 11, 200 / 11);
        }
      }, 600);
    };
...
function drawGame(context, canvas) {
  context.beginPath();
  context.strokeRect(330 / 1440 * canvas.width, 35 / 810 * canvas.height, 1100 / 1440 * canvas.width, 735 / 810 * canvas.height);
  context.stroke();
  context.closePath();
}
...
function drawFireElement(context, canvas) {
  ...
  context.drawImage(firePng, 340 / 1440 * canvas.width, 40 / 810 * canvas.height, 40 / 1440 * canvas.width, 40 / 810 * canvas.height);
  if (highlight) {
    context.beginPath();
...
function drawEarthElement(context, canvas) {
  ...
  context.drawImage(earthPng, 390 / 1440 * canvas.width, 40 / 810 * canvas.height, 40 / 1440 * canvas.width, 40 / 810 * canvas.height);
  if (highlight) {
    context.beginPath();
...
function drawLightningElement(context, canvas) {
  ...
  context.drawImage(lightningPng, 440 / 1440 * canvas.width, 40 / 810 * canvas.height, 40 / 1440 * canvas.width, 40 / 810 * canvas.height);
  if (highlight) {
    context.beginPath();
...
function drawWaterElement(context, canvas) {
  ...
  context.drawImage(waterPng, 490 / 1440 * canvas.width, 40 / 810 * canvas.height, 40 / 1440 * canvas.width, 40 / 810 * canvas.height);
  if (highlight) {
    context.beginPath();
