...
exports.generateElementBarImages = generateElementBarImages;
...
function drawElements(context, canvas, element, firePng, earthPng, lightningPng, waterPng) {
  ...
  switch (element) {
    case 'Fire':
      ...
      drawEarthElement(context, canvas, earthPng);
      drawLightningElement(context, canvas, lightningPng);
      drawWaterElement(context, canvas, waterPng);
      break;
    case 'Earth':
      drawFireElement(context, canvas, firePng);
...
function generateElementBarImages() {
  var load1 = false;
  var load2 = false;
  var load3 = false;
  var load4 = false;
  ...
  return {
    firePng: firePng,
    earthPng: earthPng,
    lightningPng: lightningPng,
    waterPng: lightningPng
  };
}
      ...
      if (this.alive) {
        switch (event.key.toLowerCase()) {
          ...
          case 'q':
            ...
            (0, _util.drawElements)(this.context, this.canvas, elements[this.element]);
            break;
          case 'e':
            this.element += 1;
            if (this.element > 3) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var imageGenerated = (0, _util.generateElementBarImages)();
