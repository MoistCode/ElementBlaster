...
function drawRulesBorder(context, canvas) {
  ...
  context.fillText('Instructions', 118 / 1440 * canvas.width, 112 / 810 * canvas.height);
...
var drawInstructions = exports.drawInstructions = function drawInstructions(context, canvas, instructionPng, movementPng) {
  ...
  context.drawImage(instructionPng, 99 / 1440 * canvas.width, 330 / 810 * canvas.height, 130 / 1440 * canvas.width, 230 / 810 * canvas.height);

  context.drawImage(movementPng, 55 / 1440 * canvas.width, 215 / 810 * canvas.height, 220 / 1440 * canvas.width, 80 / 810 * canvas.height);

  context.beginPath();
  context.font = fontSize + 'px Verdana';
  context.fillText('Move', 84 / 1440 * canvas.width, 315 / 810 * canvas.height);
  context.fillText('Shoot', 210 / 1440 * canvas.width, 315 / 810 * canvas.height);
  context.closePath();
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var endlessInterval = setInterval(generatePlayers(gameContext, gameCanvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng, 1), 5000);
