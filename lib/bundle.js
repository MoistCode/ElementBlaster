...
function drawGame(context, canvas) {
  context.beginPath();
  context.lineWidth = '5';
  context.strokeRect(330 / 1440 * canvas.width, 0 / 810 * canvas.height, 1110 / 1440 * canvas.width, 808 / 810 * canvas.height);
  context.stroke();
  context.closePath();
}
...
function drawTitle(context, canvas) {
  ...
  context.fill();
  context.closePath();
  context.font = 'italic bold 38px Verdana';
  context.fillText('BALL BLASTER', 25 / 1440 * canvas.width, 41 / 810 * canvas.height);
  context.closePath();
}
...
function drawRulesBorder(context, canvas) {
  ...
  context.fillText('3. Only bullets with the right element', 40 / 1440 * canvas.width, 140 / 810 * canvas.height);
  context.fillText('will eliminate the enemy.', 55 / 1440 * canvas.width, 158 / 810 * canvas.height);
}
...
function drawSettingsBorder(context, canvas) {
  ...
  context.lineWidth = 5;
  context.strokeRect(36 / 1440 * canvas.width, 505 / 810 * canvas.height, 260 / 1440 * canvas.width, 222 / 810 * canvas.height);
  context.closePath();
}
...
var ComputerPlayer = function (_Player) {
  ...
  function ComputerPlayer(context, canvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng) {
    ...
    console.log(_this.fireSpritePng);
    return _this;
  }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  waterSpritePng.src = '../assets/images/earthSprite.png';
  ...
  function update(imagesLoaded) {
    if (imagesLoaded >= 9 && !generated) {
      generatePlayers(gameContext, gameCanvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng);
      generated = true;
    }
    if (imagesLoaded >= 9) {
...
var generatePlayers = function generatePlayers(context, canvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng) {
  for (var i = 0; i < 3; i++) {
