...
function drawGame(context, canvas) {
  context.beginPath();
  context.lineWidth = '5';
  context.rect(330 / 1440 * canvas.width, 0 / 810 * canvas.height, 1110 / 1440 * canvas.width, 808 / 810 * canvas.height);
...
function drawRulesBorder(context, canvas) {
  ...
  context.fillText('Instructions', 118 / 1440 * canvas.width, 120 / 810 * canvas.height);
  ...
  context.fillText('3. Only bullets with the right element', 40 / 1440 * canvas.width, 185 / 810 * canvas.height);
  context.fillText('will eliminate the enemy.', 55 / 1440 * canvas.width, 203 / 810 * canvas.height);
}
...
var drawInstructions = exports.drawInstructions = function drawInstructions(context, canvas, instructionPng) {
  context.drawImage(instructionPng, 65 / 1440 * canvas.width, 235 / 810 * canvas.height, 200 / 1440 * canvas.width, 300 / 810 * canvas.height);
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function update(imagesLoaded) {
    ...
    (0, _util.drawInstructions)(gameContext, gameCanvas, instructionPng);
  }
});
