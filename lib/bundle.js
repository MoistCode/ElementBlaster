...
var drawInstructions = exports.drawInstructions = function drawInstructions(context, canvas, instructionPng, movementPng) {
  ...
  context.drawImage(movementPng, 15 / 1440 * canvas.width, 215 / 810 * canvas.height, 220 / 1440 * canvas.width, 65 / 810 * canvas.height);

  context.beginPath();
  context.font = fontSize + 'px arcade';
  context.fillText('Move', 89 / 1440 * canvas.width, 305 / 810 * canvas.height);
  context.fillText('Shoot', 215 / 1440 * canvas.width, 305 / 810 * canvas.height);
  context.closePath();
};
