  ...
  _createClass(HumanPlayer, [{
    ...
    value: function changePosition() {
      ...
      if (this.el != undefined) {
        console.log(this.el.showListOfElements());
      ...
      document.addEventListener('keydown', function (event) {
        switch (event.key.toLowerCase()) {
          ...
          case 'e':
            ...
            break;
          case 'arrowup':
            _this2.el = new _element2.default('up', _this2.coordX, _this2.coordY, _this2.context, _this2.canvas);
            break;
          case 'arrowdown':
            _this2.el = new _element2.default('down', _this2.coordX, _this2.coordY, _this2.context, _this2.canvas);
            break;
          case 'arrowleft':
            _this2.el = new _element2.default('left', _this2.coordX, _this2.coordY, _this2.context, _this2.canvas);
            break;
          case 'arrowright':
            _this2.el = new _element2.default('right', _this2.coordX, _this2.coordY, _this2.context, _this2.canvas);
            break;
        }
      });
    }
...
var Element = function () {
  function Element(direction, posX, posY, context, canvas) {
