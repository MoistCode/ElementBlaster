...
var drawInstructions = exports.drawInstructions = function drawInstructions(context, canvas, instructionPng, movementPng) {
  ...
  context.beginPath();
  context.font = fontSize + 'px arcade';
  context.fillText('Move', 81 / 1440 * canvas.width, 300 / 810 * canvas.height);
  context.fillText('Shoot', 165 / 1440 * canvas.width, 300 / 810 * canvas.height);
  context.fillText('Change Element', 213 / 1440 * canvas.width, 300 / 810 * canvas.height);
  context.closePath();
};
