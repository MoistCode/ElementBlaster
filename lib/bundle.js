  ...
  _createClass(HumanPlayer, [{
    ...
    value: function addMouseEvents() {
      ...
      document.addEventListener('click', function (event) {
        new _element2.default(_this4.coordX, _this4.coordY, event.clientX, event.clientY, elements[_this4.element]);
      });
      document.addEventListener('mousemove', function (event) {
        _this4.mouseX = event.clientX;
        _this4.mouseY = event.clientY;
      });
    }
  }, {
    ...
    value: function drawCurrentLocation() {
      ...
      this.context.closePath();
      this.context.beginPath();
      this.context.moveTo(this.coordX, this.coordY);
...
var Element = function () {
  function Element(sourceCoordX, sourceCoordY, directionX, directionY, element) {
  ...
  _createClass(Element, [{
    ...
    key: "generateStartingPosition",
    value: function generateStartingPosition() {
      var xOne = this.sourceCoordX;
      var yOne = this.sourceCoordY;
      var xTwo = this.directionX;
      var yTwo = this.directionY;
      var radius = 13;
      var adjacent = xTwo - xOne;
      var opposite = yTwo - yOne;
      var hypoteneuse = Math.sqrt(Math.pow(adjacent, 2) + Math.pow(opposite, 2));
