...
var drawInstructions = exports.drawInstructions = function drawInstructions(context, canvas, instructionPng, movementPng) {
  context.drawImage(instructionPng, 100 / 1440 * canvas.width, 325 / 810 * canvas.height, 130 / 1440 * canvas.width, 230 / 810 * canvas.height);

  context.drawImage(movementPng, 55 / 1440 * canvas.width, 220 / 810 * canvas.height, 220 / 1440 * canvas.width, 80 / 810 * canvas.height);
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  movementPng.src = '../assets/images/movement.png';
