...
var HumanPlayer = function (_Player) {
  ...
  function HumanPlayer(context, canvas) {
    ...
    _this._addUserControls();
    return _this;
  }

  _createClass(HumanPlayer, [{
    key: '_addUserControls',
    value: function _addUserControls() {
      var _this2 = this;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var human = new _humanplayer2.default(gameContext, gameCanvas);
  function animate() {
...
var _generateHumanPlayer = function _generateHumanPlayer(context, canvas) {
  new _humanplayer2.default(context, canvas);
};

var _generateComputerPlayers = function _generateComputerPlayers(context, canvas) {
  for (var i = 0; i < 25; i++) {
    new _computerplayer2.default(context, canvas);
  }
};
