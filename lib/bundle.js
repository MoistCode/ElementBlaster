...
document.addEventListener("DOMContentLoaded", function () {
  ...
  explosionPng.src = '../assets/images/explosion';
  ...
  function update(imagesLoaded) {
    if (imagesLoaded >= 4) {
      ...
      if (Object.values((0, _player.getAllPlayers)()).length > 1) {
        ...
        checkElementCollisions(els, Object.values((0, _player.getAllPlayers)()));
      }
    }
  }
});
...
var checkElementCollisions = function checkElementCollisions(els, players) {
