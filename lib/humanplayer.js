    ...
    document.addEventListener('keydown', (event) => {
      switch(event.key.toLowerCase()) {
        ...
        case 'e':
          ...
          break;
        case 'arrowup':
          this.el = new Element('up', this.coordX, this.coordY, this.context, this.canvas);
          break;
        case 'arrowdown':
          this.el = new Element('down', this.coordX, this.coordY, this.context, this.canvas);
          break;
        case 'arrowleft':
          this.el = new Element('left', this.coordX, this.coordY, this.context, this.canvas);
          break;
        case 'arrowright':
          this.el = new Element('right', this.coordX, this.coordY, this.context, this.canvas);
          break;
      }
    });
  }
