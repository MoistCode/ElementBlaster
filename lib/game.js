...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const endlessInterval = setInterval(generatePlayers(gameContext, gameCanvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng, 1), 1000);
  ...
  endlessButton.addEventListener('click', () => {
    ...
    destroyAllEnemyElements();
    humanPlayer = new HumanPlayer(gameContext, gameCanvas, humanSpritePng);
    endlessInterval = setInterval(generatePlayers(gameContext, gameCanvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng, 1), 1000);
    // generatePlayers(gameContext, gameCanvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng, 1);
  });

  function update(imagesLoaded) {
    if (imagesLoaded >= 12 && !generated) {
      humanPlayer = new HumanPlayer(gameContext, gameCanvas, humanSpritePng);
      generatePlayers(gameContext, gameCanvas, fireSpritePng, earthSpritePng, lightningSpritePng, waterSpritePng, 1);
      generated = true;
    }
